		...
		<tbody>
			...
			?>
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
						...
						<td class="product-info" data-title="<?php esc_attr_e('Subtotal', 'woocommerce'); ?>">
							<?php
							$product = $_product;
						...
						<td class="product-remove">
							...
							// Output remove link using WooCommerce's built-in AJAX functionality
							echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
								'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s">&times;</a>',
								esc_url( wc_get_cart_remove_url( $cart_item_key ) ),
								esc_attr( sprintf( __( 'Remove %s from your cart', 'woocommerce' ), $product_name ) ),
								esc_attr( $product_id ),
